...
exports.blogSchemas = {
    ...
    create: zod_2.z.object({
        body: zod_2.z.object({
            ...
            content: zod_2.z.string().min(1, "Content is required"),
            excerpt: zod_2.z.string().max(500, "Excerpt must not exceed 500 characters").optional(),
            featured_image: zod_2.z.string().url("Featured image must be a valid URL").optional().or(zod_2.z.literal("")),
            published: zod_2.z.boolean().optional(),
            tags: zod_2.z.array(zod_2.z.string().min(1, "Tag cannot be empty")).optional(),
            author: zod_2.z.string().min(1, "Author name is required").optional(),
            read_time: zod_2.z.number().int().positive("Read time must be a positive integer").optional(),
        }),
    }),
    // Blog update
    update: zod_2.z.object({
        ...
        body: zod_2.z.object({
            ...
            slug: zod_2.z.string().min(1, "Slug is required").max(200, "Slug must not exceed 200 characters")
                .regex(/^[a-z0-9-]+$/, "Slug can only contain lowercase letters, numbers, and hyphens").optional(),
            content: zod_2.z.string().min(1, "Content is required").optional(),
            excerpt: zod_2.z.string().max(500, "Excerpt must not exceed 500 characters").optional(),
            featured_image: zod_2.z.string().url("Featured image must be a valid URL").optional().or(zod_2.z.literal("")),
            published: zod_2.z.boolean().optional(),
            tags: zod_2.z.array(zod_2.z.string().min(1, "Tag cannot be empty")).optional(),
    ...
    // Blog slug parameter
    bySlug: zod_2.z.object({
        params: zod_2.z.object({
            slug: zod_2.z.string().min(1, "Slug is required"),
        }),
    }),
...
exports.projectSchemas = {
    ...
    create: zod_2.z.object({
        body: zod_2.z.object({
            ...
            short_description: zod_2.z.string().max(300, "Short description must not exceed 300 characters").optional(),
            featured_image: zod_2.z.string().url("Featured image must be a valid URL").optional().or(zod_2.z.literal("")),
            gallery_images: zod_2.z.array(zod_2.z.string().url("Gallery image must be a valid URL")).optional(),
            technologies: zod_2.z.array(zod_2.z.string().min(1, "Technology name cannot be empty")).optional(),
            github_url: zod_2.z.string().url("GitHub URL must be a valid URL").optional().or(zod_2.z.literal("")),
            live_url: zod_2.z.string().url("Live URL must be a valid URL").optional().or(zod_2.z.literal("")),
            status: zod_2.z.enum(["IN_PROGRESS", "COMPLETED", "ARCHIVED"]).optional(),
            featured: zod_2.z.boolean().optional(),
            order_index: zod_2.z.number().int().optional(),
        }),
    }),
    // Project update
    update: zod_2.z.object({
        ...
        body: zod_2.z.object({
            ...
            slug: zod_2.z.string().min(1, "Slug is required").max(200, "Slug must not exceed 200 characters")
                .regex(/^[a-z0-9-]+$/, "Slug can only contain lowercase letters, numbers, and hyphens").optional(),
            description: zod_2.z.string().min(1, "Description is required").optional(),
            short_description: zod_2.z.string().max(300, "Short description must not exceed 300 characters").optional(),
            featured_image: zod_2.z.string().url("Featured image must be a valid URL").optional().or(zod_2.z.literal("")),
            gallery_images: zod_2.z.array(zod_2.z.string().url("Gallery image must be a valid URL")).optional(),
            technologies: zod_2.z.array(zod_2.z.string().min(1, "Technology name cannot be empty")).optional(),
    ...
    byStatus: zod_2.z.object({
        params: zod_2.z.object({
            status: zod_2.z.enum(["IN_PROGRESS", "COMPLETED", "ARCHIVED"]),
        }),
    }),
    ...
    reorder: zod_2.z.object({
        body: zod_2.z.object({
            projectOrders: zod_2.z.array(zod_2.z.object({
                project_id: zod_2.z.number().int().positive("Project ID must be a positive integer"),
                order_index: zod_2.z.number().int("Order index must be an integer"),
