...
router.get("/getPublishedBlogs", (0, validation_1.validateSchema)(validation_1.blogSchemas.query), asyncHandler(BlogController_1.GetPublishedBlogs));
...
router.post("/createBlog", auth_1.authenticateAdmin, (0, validation_1.validateSchema)(validation_1.blogSchemas.create), asyncHandler(BlogController_1.CreateBlog));
...
router.delete("/:id", auth_1.authenticateAdmin, (0, validation_1.validateSchema)(validation_1.blogSchemas.byId), asyncHandler(BlogController_1.DeleteBlog));
