    ...
    <div className="flex flex-col min-h-screen bg-[#f4f2ee]">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-base sm:text-lg md:text-xl font-light [font-family:'Lexend_Deca',Helvetica] text-[#6e6d6b] mb-6 sm:mb-8 max-w-sm sm:max-w-xl md:max-w-2xl mx-auto leading-relaxed px-2 ">
          I'm a Computer Science undergraduate with a strong passion for AI/ML and building intelligent, data-driven systems.
          I'm currently building expertise in machine learning and natural language processing, working with frameworks like TensorFlow and Hugging Face to design models that solve real-world problems. My flagship project, TweetWatch, is an AI-powered content moderation system that uses NLP to analyze social media posts and detect harmful or policy-violating content at scale. I've also worked on integrating OCR pipelines and ML-based recommendation systems into production-style applications, giving me hands-on experience in taking models beyond notebooks and into deployable features.
          To complement my ML work, I have a solid foundation in full-stack web development using the MERN stack (MongoDB, Express.js, React, Node.js), which lets me build the applications that actually serve these models to users. My project Pet Buddy, a pet care platform with health record management, community forums, and real-time chat, reflects this — combining clean UI/UX with backend systems robust enough to support AI features.
          Underpinning all of this is a strong grounding in DBMS, where I focus on designing normalized schemas, writing optimized queries, and managing data integrity across relational (PostgreSQL) and NoSQL (MongoDB) systems, with Redis for caching and performance. I also place strong emphasis on software testing, writing unit and integration tests to ensure reliability, catch regressions early, and validate model behavior before deployment — because an ML system is only as trustworthy as the tests behind it.
          I'm strengthening my problem-solving and analytical thinking through Data Structures and Algorithms in C++, having solved 170+ problems on LeetCode and 100+ on GeeksforGeeks. I also have experience with TypeScript, Docker, and secure authentication systems, rounding out my ability to build scalable, well-tested, intelligent applications end to end.
          I'm always excited to discuss AI/ML, collaborate on projects, and learn from experienced professionals in the field. Feel free to reach out at rohit.dhawadkar@gmail.com or connect with me on LinkedIn.</p>
